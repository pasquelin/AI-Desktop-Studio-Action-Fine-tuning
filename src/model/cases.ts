...
const requests: [language: string, project: string, cube: string][] = [
  ...
  ['ar', 'أنشئ مشروعًا باسم "Atlas" في /vm/projects.', 'أضف مكعبًا باسم "Marker" إلى المشهد الحالي.'],
  ['hi', '/vm/projects में "Atlas" नाम का प्रोजेक्ट बनाओ।', 'वर्तमान दृश्य में "Marker" नाम का एक घन जोड़ो।'],
  [
    'zh',
...
export const modelCases: ModelCase[] = requests.flatMap(([language, project, cube]) => [
  {
    id: `${language}-project`,
    language,
    prompt: project,
    context: 'No project is open. The explicit destination is a synthetic test path.',
    expected: {
      name: 'project_create',
  ...
  },
  {
    ...
    language,
    prompt: cube,
    context: 'A project and a 3D scene are open and ready. No position was specified.',
    expected: {
      name: 'node_add',
